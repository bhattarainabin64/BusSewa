...
class _UserRegistrationScreenState extends State<UserRegistrationScreen> {
  ...
  Future signInwithGoogle() async {
    ...
    try {
      ...
      print("first name " +
          auth.currentUser!.displayName.toString().split(" ")[0]);
      print("last name " +
          auth.currentUser!.displayName.toString().split(" ")[1]);
      print("email" + auth.currentUser!.email.toString());
      print("uid${user!.uid}");

      await FirebaseFirestore.instance.collection('user').doc(user!.uid).set(
        {
          'firstname': auth.currentUser!.displayName.toString().split(" ")[0],
          'lastname': auth.currentUser!.displayName.toString().split(" ")[1],
