...
class _SupportingDoc3State extends State<SupportingDoc3> {
  ...
  Future _documentVerification() async {
    ...
    try {
      ...
      const SnackBar(content: Text("Failed to upload image!!")).show(context);
      print('Failed to upload image $e');
    }

    try {
      User? user = FirebaseAuth.instance.currentUser;
      DatabaseReference riderVerification = FirebaseDatabase.instance
          .ref()
          .child('user/${user!.uid}/verification');
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                GestureDetector(
                  onTap: () {
                    _loadFrontImage(ImageSource.gallery);
                  },
                  child: Column(
                    children: [
                      licence_front == null
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                GestureDetector(
                  onTap: () {
                    _loadBackImage(ImageSource.gallery);
                  },
                  child: Column(
                    children: [
                      licence_back == null
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                GestureDetector(
                  onTap: () {
                    _loadBillbook1(ImageSource.gallery);
                  },
                  child: Column(
                    children: [
                      billbook1 == null
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                GestureDetector(
                  onTap: () {
                    _loadBillbook2(ImageSource.gallery);
                  },
                  child: Column(
                    children: [
                      billbook2 == null
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                GestureDetector(
                  onTap: () {
                    _loadBillbook3(ImageSource.gallery);
                  },
                  child: Column(
                    children: [
                      billbook3 == null
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                GestureDetector(
                  onTap: () {
                    _loadBillbook4(ImageSource.gallery);
                  },
                  child: Column(
                    children: [
                      billbook4 == null
